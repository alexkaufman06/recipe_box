...
ActiveRecord::Schema.define(version: 20150129181201) do
  ...
  add_index "categories_recipes", ["ingredient_id"], name: "index_categories_recipes_on_ingredient_id", using: :btree
